    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(to='books.Author', verbose_name='作者')),
            ],
        ),
        migrations.CreateModel(
            name='Classification',
        ...
        migrations.AddField(
            model_name='book',
            name='tags',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='books.Tags', verbose_name='標籤'),
        ),
    ]
